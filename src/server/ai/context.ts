...
const summaryContext =
  "Adesh Tamrakar is a full-stack engineer based in Indore, India with 3+ years of experience building production-grade web apps. He enjoys owning projects end-to-end, from requirements to deployment, and focuses on delivering measurable impact.";
...
const skillsContext =
  "Core stack: JavaScript, TypeScript, React, Next.js, Node.js, PostgreSQL, Prisma/Drizzle ORM, AWS serverless, Kafka, Docker, Redis, ElasticSearch, testing (unit/e2e), and clean architecture.";

const achievementsContext =
  "Awards: Rookie of the Quarter at Infosys for perfect client satisfaction. Built a course platform in college that onboarded 50+ paying users.";
