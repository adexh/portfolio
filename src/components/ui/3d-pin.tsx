...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="w-96 h-[20rem] flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none ">
